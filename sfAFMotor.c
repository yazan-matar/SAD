 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Thu May 30 17:28:28 2019
 */
...
extern void sfAFMotor_Outputs_wrapper(const uint8_T *DIR1,
			const uint8_T *PWM1,
			const uint8_T *DIR2,
			const uint8_T *PWM2,
			const uint8_T *DIR3,
...
{
    const uint8_T *DIR1 = (uint8_T *) ssGetInputPortRealSignal(S, 0);
    const uint8_T *PWM1 = (uint8_T *) ssGetInputPortRealSignal(S, 1);
    const uint8_T *DIR2 = (uint8_T *) ssGetInputPortRealSignal(S, 2);
    const uint8_T *PWM2 = (uint8_T *) ssGetInputPortRealSignal(S, 3);
    const uint8_T *DIR3 = (uint8_T *) ssGetInputPortRealSignal(S, 4);
    const uint8_T *PWM3 = (uint8_T *) ssGetInputPortRealSignal(S, 5);
    const uint8_T *DIR4 = (uint8_T *) ssGetInputPortRealSignal(S, 6);
    const uint8_T *PWM4 = (uint8_T *) ssGetInputPortRealSignal(S, 7);

    sfAFMotor_Outputs_wrapper(DIR1, PWM1, DIR2, PWM2, DIR3, PWM3, DIR4, PWM4);
